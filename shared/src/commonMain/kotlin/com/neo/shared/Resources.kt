package com.neo.shared


// to get access to shared resources to other modules that depend on this
...
/**
 * To get access to shared resources to other modules that depend on
 * better way to automate this is by using this in gradle
 * compose.resources {
 *     publicResClass = true
